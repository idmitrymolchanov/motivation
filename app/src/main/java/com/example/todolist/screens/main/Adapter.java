...
import com.example.todolist.screens.secondary.CalendarActivity;
...
public class Adapter extends RecyclerView.Adapter<Adapter.NoteViewHolder> {
    ...
    static class NoteViewHolder extends RecyclerView.ViewHolder {
        ...
        public NoteViewHolder(@NonNull final View itemView) {
            ...
            materialCalendarView = itemView.findViewById(R.id.calendarView2);
            imageButtonAdd = itemView.findViewById(R.id.imageButton_add);
            imageButtonRemove = itemView.findViewById(R.id.imageButton_remove);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    CalendarActivity.start((Activity) itemView.getContext(), noteText.getText().toString());
                }
            });
